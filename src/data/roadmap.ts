...
export const ITEMS: BuildItem[] = [
  ...
  { id: 'addrow', group: 'Foundations', status: 'built', title: 'Adding something directly',
    note: 'Capture was the only way anything got created — fine for a thought you have not decided about, and six taps per person when you already know. People and Commitments now have an add row: type, press enter, keep going. Enter adds another so a list can be seeded in one pass, and Add & open takes you straight into the details.' },
  { id: 'firstrun', group: 'Foundations', status: 'built', title: 'The first morning',
    note: 'Signed in with nothing in it, every section hides itself and the page reads as broken rather than calm. Three things to do first, each explaining why rather than instructing, and it disappears the moment there is anything in there.' },
